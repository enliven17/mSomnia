...
import { syncOnChainMarkets } from "@/store/marketsSlice";
...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    // 2025 yılı için oluşturulan Somnia marketleri getirilecek
    // Hata olursa sessizce devam eder
    // @ts-ignore
    dispatch(syncOnChainMarkets());
  }, [dispatch]);
      ...
      <Header>
        ...
        <Stats>
          ...
          <StatItem>
            ...
            <StatContent>
              <StatValue>{totalPool.toFixed(1)} STT</StatValue>
